...
function addToCloud(e){
  ...
  axios.post("https://crudcrud.com/api/522f71b767124a298ea86b8bd90af617/appointmentData",myObj)
...
window.addEventListener("DOMContentLoaded", ()=>{
  axios.get("https://crudcrud.com/api/522f71b767124a298ea86b8bd90af617/appointmentData")
  .then((response) => { 
...
function addToItemList (dataObject){
  ...
  const childNode = `<li id=${dataObject.email}> ${dataObject.name}-${dataObject.email}<button onclick="editUserDetails('${dataObject.name}','${dataObject.email}','${dataObject.phone}','${dataObject.date}','${dataObject.time}','${dataObject.message}')" type='submit' id = theEditBtn > Edit </button>
  <button onclick=deleteUser('${dataObject.email}','${dataObject._id}') id = 'theDeleteBtn' > Delete </button>
  </li>`
...
function deleteUser(email,id){
  // alert(`https://crudcrud.com/api/522f71b767124a298ea86b8bd90af617/appointmentData/${id}`)
  axios.delete(`https://crudcrud.com/api/522f71b767124a298ea86b8bd90af617/appointmentData/${id}`).then(()=>removeItemFromList(email))
  .catch((err)=>console.error(err))
}
